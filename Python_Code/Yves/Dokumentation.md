...
- Der client -> IP vom Server oder vom Proxy angeben (Enter), Port vom Server oder Proxy angeben (Enter), Zahl n angeben z.B. 15 (Enter) (Ohne Eingabe = Default vom Server)
